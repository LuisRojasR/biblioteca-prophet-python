...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    {\Large Análisis estadístico descriptivo de 60 datos simulados con Python \par}
...
En el presente informe se desarrolla un análisis estadístico descriptivo a partir de una muestra simulada digitalmente de 60 datos enteros comprendidos entre 00 y 99. El contexto seleccionado corresponde a los tiempos de respuesta, medidos en segundos, de 60 estudiantes al resolver un cuestionario corto de estadística en formato digital. Este tema fue elegido por ser coherente con el entorno académico y por permitir aplicar de manera clara las herramientas vistas en clase.

Es importante destacar que, cumpliendo con los requerimientos de la asignatura, tanto para la generación aleatoria de los datos como para la construcción de las tablas de frecuencias y las representaciones gráficas, se emplearon herramientas computacionales, específicamente el lenguaje de programación Python y sus bibliotecas especializadas en ciencia de datos (\texttt{numpy}, \texttt{pandas}, \texttt{matplotlib} y \texttt{seaborn}).
...
Analizar estadísticamente una muestra de 60 datos simulados mediante tablas, gráficos y medidas descriptivas procesadas computacionalmente, con el propósito de interpretar su comportamiento y aplicar los conceptos desarrollados en el curso de Probabilidad y Estadística.
...
De acuerdo con los lineamientos establecidos para este avance, la recolección de información no se realizó mediante la observación de un fenómeno real, sino a través de un proceso de \textbf{simulación digital controlada} utilizando el lenguaje de programación Python. El procedimiento consistió en generar un conjunto de 60 números enteros, seleccionados al azar mediante el uso de bibliotecas computacionales (como \texttt{numpy.random} o \texttt{random.randint}), bajo la estricta condición de estar comprendidos entre el 00 y el 99. 

Desde el punto de vista teórico, este método de generación de datos equivale a un \textbf{muestreo probabilístico de tipo aleatorio simple}. Se clasifica como probabilístico porque, al elegir los números de forma aleatoria estructurada, cualquier valor entero dentro del intervalo [00, 99] tenía teóricamente la misma probabilidad de ser seleccionado para conformar la muestra, evitando así un sesgo de selección intencional.
...
Con el fin de resumir y organizar la información, los datos se agruparon en intervalos de amplitud 10 (proceso estructurado computacionalmente con la ayuda de \texttt{pandas}). Para cada intervalo se calculó la frecuencia absoluta, la frecuencia acumulada, la frecuencia relativa y la frecuencia relativa acumulada.
...
A continuación se presentan las gráficas estadísticas construidas a partir de la muestra analizada, las cuales fueron procesadas y renderizadas utilizando bibliotecas de Python como \texttt{matplotlib} y \texttt{seaborn}.
...
\begin{itemize}[leftmargin=1.2cm]
    \item La muestra simulada de 60 datos permitió aplicar de forma completa los principales conceptos de la estadística descriptiva empleando herramientas computacionales en Python.
...
\begin{itemize}[leftmargin=1.2cm]
    \item Repositorio y código fuente del análisis computacional en Python: \url{https://github.com/LuisRojasR/biblioteca-prophet-python/blob/81d8f26f4ad77705a5e970e26182d53242959672/Talleres\%20Probabilidad\%20y\%20Estadistica/Informe_Estadistica-2.pdf}
