...
\begin{itemize}[leftmargin=1.2cm]
    \raggedright % Crucial para que los enlaces no fuercen el ancho de la página

    \item Rojas~Rada, L.~F. y Sánchez~Escobar, A. (2026).
    \textit{Informe de análisis estadístico -- documento PDF}.
    Repositorio GitHub: \textit{biblioteca-python}.
    \href{https://github.com/LuisRojasR/biblioteca-prophet-python/blob/8c94871bae57a6c5d2d7cae6ed869f459f7d535e/Talleres%20Probabilidad%20y%20Estadistica/Informe%20de%20an%C3%A1lisis%20estad%C3%ADstico.pdf}{[Ver documento PDF en GitHub]}

    \item Rojas~Rada, L.~F. y Sánchez~Escobar, A. (2026).
    \textit{Informe de análisis estadístico -- código fuente \LaTeX{}}.
    Repositorio GitHub: \textit{biblioteca-python}.
    \href{https://github.com/LuisRojasR/biblioteca-prophet-python/blob/ddd6b70649beb38648a4b15fad86241a9cfda42d/Talleres%20Probabilidad%20y%20Estadistica/Informe%20de%20an%C3%A1lisis%20estad%C3%ADstico(LATEX).tex}{[Ver código fuente \LaTeX{} en GitHub]}

    \item Rojas~Rada, L.~F. y Sánchez~Escobar, A. (2026).
    \textit{Validación computacional del análisis estadístico -- código Python}.
    Google Colaboratory.
    \href{https://colab.research.google.com/drive/1riZwUWHigjchCFgcGBNGb3CCEc0Y06RA?usp=sharing}{[Ver código Python en Google Colab]}
